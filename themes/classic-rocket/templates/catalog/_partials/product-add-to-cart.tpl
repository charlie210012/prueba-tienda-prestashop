...
<div class="product-add-to-cart">
  {if !$configuration.is_catalog}
    ...
    {block name="actionsButtons"}
        <div class="row add">
          <div class="col-md-6">
            <button
              class="btn btn-white text-lowercase add-to-cart btn-lg btn-block btn-add-to-cart js-add-to-cart"
          ...
          <div class="col-md-6">
            <button
              class="btn btn-primary fw-bold add-to-cart btn-lg btn-block btn-add-to-cart js-add-to-cart"
              style="
