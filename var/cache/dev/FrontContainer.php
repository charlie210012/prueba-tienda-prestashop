...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\www\\prueba-tienda-prestashop\\modules\\productcomments\\src\\Entity']);
        $d->addExcludePaths([0 => 'C:\\laragon\\www\\prueba-tienda-prestashop\\modules\\productcomments\\src\\Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\www\\prueba-tienda-prestashop\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('C:\\laragon\\www\\prueba-tienda-prestashop/var/cache/dev\\/doctrine/orm/Proxies');
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(true);
        $a->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $a->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('ca_'))) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\laragon\\www\\prueba-tienda-prestashop/var/cache/dev\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\laragon\\www\\prueba-tienda-prestashop/var/cache/dev\\/localization'))) && false ?: '_'});
    ...
    {
        return $this->services['product_comment_criterion_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentCriterionRepository(${($_ = isset($this->services['doctrine.dbal.default_connection']) ? $this->services['doctrine.dbal.default_connection'] : $this->getDoctrine_Dbal_DefaultConnectionService()) && false ?: '_'}, 'ca_');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('ca_');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\laragon\\www\\prueba-tienda-prestashop/app',
            'kernel.project_dir' => 'C:\\laragon\\www\\prueba-tienda-prestashop',
            'kernel.name' => 'app',
            'kernel.debug' => true,
            'kernel.environment' => 'dev',
            'kernel.cache_dir' => 'C:\\laragon\\www\\prueba-tienda-prestashop/var/cache/dev\\',
            'kernel.active_modules' => [
                ...
                57 => 'blockreassurance',
                58 => 'ps_facetedsearch',
                59 => 'ps_searchbarjqauto',
                60 => 'weatherinfo',
                61 => 'importcsvproducts',
                62 => 'customproducthtml',
                63 => 'customproducttext',
            ],
            'ps_cache_dir' => 'C:\\laragon\\www\\prueba-tienda-prestashop/var/cache/dev\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\laragon\\www\\prueba-tienda-prestashop/var/cache/dev\\/doctrine/orm/Proxies',
