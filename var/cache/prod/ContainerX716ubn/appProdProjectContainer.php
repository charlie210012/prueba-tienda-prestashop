...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9J+ysSi8ru', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_e788f31bb5bcb4c57596ce40f78a40274cf3657f46c6f7a914c003b1ba40ad1d');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                53 => ($this->targetDirs[3].'/modules/importcsvproducts/translations'),
                54 => ($this->targetDirs[3].'/modules/weatherinfo/translations'),
                55 => ($this->targetDirs[3].'/modules/customproducttext/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                60 => 'importcsvproducts',
                61 => 'customproducthtml',
                62 => 'weatherinfo',
